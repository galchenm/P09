...
# /asap3/petra3/gpfs/p09/2023/data/11016750/processed/guents/refinement/F2X/data/autorefinement/individualres
...
def run_partialator(hkl_input_file, highres, pg, pdb, nsh, suffix=''):
    ...
    if os.path.exists(f'{data}.hkl1') and os.path.exists(f'{data}.hkl2'):
        ...
        return "%s_CCstar.dat" % data_output_name, "%s.err" % data_output_name
    else:
