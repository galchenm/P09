...
def run_partialator(hkl_input_file, highres, pg, pdb, nsh, suffix=''):
...
def processing(CCstar_dat_file, error_filename_to_parse, Rwork, Rfree, resolution_cut_off):
...
def prep_for_calculating_overall_statistics(input_prior_information):
    phenix_log_file, resolution_cut_off, offset = input_prior_information
